...
- Kept collaboration assets (`.agents`, `.claude`, `.github`, `AGENTS.md`) for shared contributor workflow, and replaced private-domain examples with public-safe placeholders.
